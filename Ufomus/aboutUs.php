...
<body>
    <section id="promo" class="promo">
        <header class="header">
            <div class="header-wrapper"><a href="index.php" class="header-wrapper__link">Каталог курсов</a> <a
                    href="index.php" class="header-wrapper__link">Акции</a> <a href="./index.php"
        ...
        <div class="container">
            <div class="aboutUs">
                <div class="aboutUs-wrapper">
                    <div class="aboutUs__title">UFomus-Площадка предоставляющая<br>интернет образование</div>
                    <div class="aboutUs__descr">Мы предлагаем большой выбор курсов для профессионального и личностного
                        развития На протяжении прохождения курса мы предоставляем доступ ученику к личному кабинету, где
                        будут публиковаться лекционный материал, а так же практические занятия. Даже после завершения
                        курса, клиент сможет использовать отправленные материалы, если ему нужно освежить память</div>
                </div>
            </div>
        </div>
    </section>
