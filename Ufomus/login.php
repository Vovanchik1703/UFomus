...
<body>
    <section id="promo" class="promo">
        ...
        <div class="container">
            <div class="login">
                <div class="login__wrapper"><img src="icons/Autoriz_icon.svg" alt="login" class="login__img">
                    <div class="login__form">
                        <div class="login__form__title">У вас есть аккаунт?<br>Тогда входите!</div>
                        <form action=""><input type="email" placeholder="Email address"> <input type="password"
                                placeholder="Password"> <button class="buttons__login" href="/personalAccount.php" >Продолжить</button></form><a
                            href="sign.php" class="login__link">Нет аккаунта? тогда быстрее регистрируйся!</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    $query =mysql_query("SELECT * FROM usertbl WHEREusername='".$email."' AND password='".$password."'");
                ...
                <div class="footer-wrapper-block">
                    ...
                    <div class="footer-wrapper-block__links">
                        <div class="footer-wrapper-block__links__title">Компания</div><a href="#about"
                            class="footer-wrapper-block__links__link">О нас</a><br><a href=""
