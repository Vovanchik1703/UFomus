    ...
    <section id="course" class="course">
        <div class="container">
            <div class="course-navigation">
                ...
                <div class="course-navigation__links">
                        <a href="./IT.php" class="course-navigation__links__link">It-сфера</a> 
                        <a href="./english.php" class="course-navigation__links__link">Иностранные языки</a> 
                        <a href="./psychology.php"class="course-navigation__links__link">Психология</a> 
                        <a href="./marketing.php"  class="course-navigation__links__link">Маркетинг</a>
                </div>
            </div>
            <div class="course-block">
                <div class="course-block__line"></div>
                <div class="course-block__wrapper">
                    <h2 class="title_min title_white">It-сфера</h2>
                    <div class="course-block__wrapper__content">
                        ...
                        <div class="course-block__wrapper__content__card course-block__wrapper__content__card_purple">
                            <div class="course-block__wrapper__content__card__block">
                                <div class="course-block__wrapper__content__card__block__title">Специалист по кибер
                                    безопастности</div>
                                <div class="course-block__wrapper__content__card__block__cost">Стоимость курса <span
                            ...
                            <div class="course-block__wrapper__content__card__image"><img src="img/breed.png" alt="web">
                            </div>
                        </div>
                    </div>
                    <div class="course-block__wrapper__content">
