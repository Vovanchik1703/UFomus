        ...
        <header class="header">
            <div class="header-wrapper"><a href="#course" class="header-wrapper__link">Каталог курсов</a> <a
                    ...
                    <div class="buttons"><a href="login.php"><button
                            class="buttons__button buttons__button_white">выйти</button></a> <a href="logout.php">
                    <a href="personalAccount.php", class= account > Личный кабинет </a>

        </header>
        <div class="container">
            <div class="personalAccount">
                <div class="personalAccount__title">Личный кабинет</div>
                <div class="personalAccount__wrapper"><img src="img/personalAccount.png" alt="personalAccount"
                        class="personalAccount__img">
                    <div class="personalAccount__info">Email:</div>
                </div>
            </div>
        </div>
    </section>
