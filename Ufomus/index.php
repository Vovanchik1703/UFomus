	...
	<section id="promo" class="promo">
		<header class="header">
			<div class="header-wrapper"><a href="#course" class="header-wrapper__link">Каталог курсов</a> <a
				...
				<!-- Личный кабинет <div class="buttons">
				<a href="" class="buttons__user">Личный кабинет
		...
		<div id="modal" class="modal">
			<div class="modal__body">
				<div class="modal__content"><a href="./index.php" class="modal__exit">x</a>
					...
					<div class="modal__text">Мы предоставляем пользователям качественную среду для обучения , а так же
						трудосутраиваем наших пользователей.</div><img src="icons/Info_icon.svg" alt="Info_icon"
						class="modal__img"> <a href="#course" class="modal__link">Заинтересовался? тогда листай дальше,
						доперечня наших курсов</a>
				</div>
			</div>
		</div>
		<div class="container">
			<div class="promo__block">
				<h1 class="title">Хочешь самосовершенствоваться и развиваться?<br>Тогда тебе точно к нам!</h1><a
					href="#modal"><button class="button buttons__button__promo">Подробнее</button></a>
			</div>
		</div>
	</section>
	<section class="sale">
		...
		<div class="container">
			...
			<div class="course-block">
				...
				<div class="course-block__wrapper">
					<h2 class="title_min title_white">Популярные курсы</h2>
					<div class="course-block__wrapper__content">
						<div class="course-block__wrapper__content__card">
							<div class="course-block__wrapper__content__card__block">
								<div class="course-block__wrapper__content__card__block__title">Веб дизайнер</div>
								<div class="course-block__wrapper__content__card__block__cost">Стоимость курса <span
										class="course-block__wrapper__content__card__block__cost_old">25000</span><br><span
										class="course-block__wrapper__content__card__block__cost_new">12 500</span>
								</div>
								<div class="buttons__button buttons__button_pink">В корзину</div>
								<div class="course-block__wrapper__content__card__block__time">12 месяцев*</div>
							</div>
							<div class="course-block__wrapper__content__card__image"><img src="img/web.png" alt="web">
							</div>
						</div>
						<div class="course-block__wrapper__content__card course-block__wrapper__content__card_purple">
							<div class="course-block__wrapper__content__card__block">
								<div class="course-block__wrapper__content__card__block__title">Умение общаться</div>
								<div class="course-block__wrapper__content__card__block__cost">Стоимость курса <span
										class="course-block__wrapper__content__card__block__cost_old">12000</span><br><span
										class="course-block__wrapper__content__card__block__cost_new">6000</span></div>
								<div class="buttons__button buttons__button_pink">В корзину</div>
								<div class="course-block__wrapper__content__card__block__time">6 месяцев*</div>
							</div>
							<div class="course-block__wrapper__content__card__image"><img src="img/obshenie.png"
									alt="web"></div>
						</div>
					</div>
					<div class="course-block__wrapper__content">
						<div class="course-block__wrapper__content__card course-block__wrapper__content__card_blue">
							<div class="course-block__wrapper__content__card__block">
								<div class="course-block__wrapper__content__card__block__title">Английский язык</div>
								<div class="course-block__wrapper__content__card__block__cost">Стоимость курса <span
										class="course-block__wrapper__content__card__block__cost_old">18000</span><br><span
										class="course-block__wrapper__content__card__block__cost_new">12 000</span>
								</div>
								<div class="buttons__button buttons__button_pink">В корзину</div>
								<div class="course-block__wrapper__content__card__block__time">10 месяцев*</div>
							</div>
							<div class="course-block__wrapper__content__card__image"><img src="img/English.png"
									alt="web"></div>
						</div>
						...
						<div class="course-block__wrapper__content__card course-block__wrapper__content__card_green">
							<div class="course-block__wrapper__content__card__block">
								<div
									...
									Графичесикй<br>дизайн</div>
								<div class="course-block__wrapper__content__card__block__cost">Стоимость курса <span
										class="course-block__wrapper__content__card__block__cost_old">20000</span><br><span
										class="course-block__wrapper__content__card__block__cost_new">10000</span></div>
								<div class="buttons__button buttons__button_pink">В корзину</div>
								<div class="course-block__wrapper__content__card__block__time">11 месяцев*</div>
							</div>
							<div class="course-block__wrapper__content__card__image"><img src="img/design.png"
									alt="web"></div>
						</div>
						<div class="course-block__wrapper__content__card course-block__wrapper__content__card_grey">
							<div class="course-block__wrapper__content__card__block">
								<div
									class="course-block__wrapper__content__card__block__title course-block__wrapper__content__card__block__title_center">
									Python для<br>начинающих</div>
								<div class="course-block__wrapper__content__card__block__cost">Стоимость курса <span
										class="course-block__wrapper__content__card__block__cost_old">17000</span><br><span
										class="course-block__wrapper__content__card__block__cost_new">8500</span></div>
								<div class="buttons__button buttons__button_pink">В корзину</div>
								<div class="course-block__wrapper__content__card__block__time">6 месяцев*</div>
							</div>
							<div class="course-block__wrapper__content__card__image"><img src="img/web.png" alt="web">
