        ...
        <div class="container">
            ...
            <div class="course-block">
                ...
                <div class="course-block__wrapper">
                    <h2 class="title_min title_white">Иностранные языки</h2>
                    <div class="course-block__wrapper__content">
                        ...
                        <div class="course-block__wrapper__content__card course-block__wrapper__content__card_purple">
                            <div class="course-block__wrapper__content__card__block">
                                <div class="course-block__wrapper__content__card__block__title">Испансикй язык</div>
                                <div class="course-block__wrapper__content__card__block__cost">Стоимость курса <span
                                        class="course-block__wrapper__content__card__block__cost_existing">9000</span>
                                </div>
                                <div class="buttons__button buttons__button_pink">В корзину</div>
                                <div class="course-block__wrapper__content__card__block__time">8 месяцев*</div>
                            </div>
                            <div class="course-block__wrapper__content__card__image"><img src="img/ispan.png" alt="web">
                            </div>
                        </div>
                    </div>
                    <div class="course-block__wrapper__content">
                        <div class="course-block__wrapper__content__card course-block__wrapper__content__card">
                            <div class="course-block__wrapper__content__card__block">
                                <div class="course-block__wrapper__content__card__block__title">Китайский язык</div>
                                <div class="course-block__wrapper__content__card__block__cost">Стоимость курса <span
                                        class="course-block__wrapper__content__card__block__cost_existing">10000</span>
                                </div>
                                <div class="buttons__button buttons__button_pink">В корзину</div>
                                <div class="course-block__wrapper__content__card__block__time">10 месяцев*</div>
                            </div>
                            <div class="course-block__wrapper__content__card__image"><img src="img/kitaiski.png"
                                    alt="web"></div>
                        </div>
                    </div>
                </div>
